        ...
        with tabs_[0]:
            ...
            if CSM_ is None: 
                ...
                if CSM_['NuXL:NA'].str.contains('none').any():
                    ...
                    ion_annotation_filter = st.selectbox(
                        "Annotated peaks",
                        options=[
                            "all_annotated_peaks",
                            "only_b_ions",
                        ...
                        index=0,
                        help=(
                            "Choose which annotations to display. If the corresponding mzML "
                            "MS2 spectrum is available, all experimental peaks are still shown "
                            "and only the selected annotations are labeled. If mzML is not "
                            "available, only the selected annotated idXML peaks are shown."
                        ),
                    )
