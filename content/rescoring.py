...
id_file = r"/home/arslan/test_rescore/RNA_UV_Ecoli_S100_LB_bRfrac_9.idXML"
calibration = r"/home/arslan/NuXL_rescore/calibration_data/RNA_All.csv"
unimod = r"/home/arslan/NuXL_rescore/unimod/unimod_to_formula.csv"
feat_config = r"/home/arslan/NuXL_rescore/features-config.json"
model_path = r"/home/arslan/NuXL_rescore/RT_deeplc_model/generic_model/full_hc_Train_RNA_All"
    ...
    with st.status("Running analysis... Please wait until analysis done 😑"):
        ...
        if os.name == 'nt':  
            ...
            if Retention_time_features:
                if protocol == 'RNA_DEB':
                    model_path = r"/home/arslan/NuXL_rescore/RT_deeplc_model/specific_model/full_hc_Train_RNA_DEB"
                    calibration_data = r"/home/arslan/NuXL_rescore/calibration_data/RNA_DEB.csv"
                    st.write("Using RNA_DEB specific model and calibration data.")

                elif protocol == 'RNA_NM':
                    model_path = r"/home/arslan/NuXL_rescore/RT_deeplc_model/specific_model/full_hc_Train_RNA_NM"
                    calibration_data = r"/home/arslan/NuXL_rescore/calibration_data/RNA_NM.csv"
                    st.write("Using RNA_NM specific model and calibration data.")

                elif protocol == 'RNA_4SU':
                    model_path = r"/home/arslan/NuXL_rescore/RT_deeplc_model/specific_model/full_hc_Train_RNA_4SU"
                    calibration_data = r"/home/arslan/NuXL_rescore/calibration_data/RNA_4SU.csv"
                    st.write("Using RNA_4SU specific model and calibration data.")

                elif protocol == 'RNA_UV' or protocol == "RNA_Other":
                    model_path = r"/home/arslan/NuXL_rescore/RT_deeplc_model/generic_model/full_hc_Train_RNA_All"
                    calibration_data = r"/home/arslan/NuXL_rescore/calibration_data/RNA_All.csv"
            ...
            if Retention_time_features and not Max_correlation_features:
                ...
                args =["nuxl_rescore", "-id", idXML_file, "-calibration", calibration,
                ...
                # Assume 'posix' for Linux and macOS
                args =["nuxl_rescore", "-id", selected_id_file, "-calibration", calibration,
                     "-unimod", unimod, "-feat_config", feat_config, "-model_path", model_path, "-out", output_path]
            #else:
                # Assume 'posix' for Linux and macOS
            #    args =["nuxl_rescore", "-id", selected_id_file, "-calibration", calibration,
